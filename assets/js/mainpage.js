...
function getCharacters(){
    const char_url = `http://gateway.marvel.com/v1/public/characters?&ts=1&apikey=9ee03c81a57d11f5044f9a9679fb75b7&hash=6a59d2d0c8f88d556f02ff14854543e5&limit=100`
    getCharApi(char_url)
}
getCharacters()
...
searchbar.onkeyup = function(event){
    ...
    if(userData!=''){
        ...
        var api_url = `http://gateway.marvel.com/v1/public/characters?nameStartsWith=${userData}&ts=1&apikey=9ee03c81a57d11f5044f9a9679fb75b7&hash=6a59d2d0c8f88d556f02ff14854543e5`
        getApi(api_url)
    }
